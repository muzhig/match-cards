...
function App() {
  const wordsPairs = [
    ...
    {words: ['yellow'], pictures: [], color: 'yellow', categories: ['colors'], weight: 0.2},
    {words: ['red'], pictures: [], color: 'red', categories: ['colors'], weight: 0.2},
    {words: ['blue'], pictures: [], color: 'blue', categories: ['colors'], weight: 0.2},
    {words: ['green'], pictures: [], color: 'green', categories: ['colors'], weight: 0.2},
    {words: ['orange'], pictures: [], color: 'orange', categories: ['colors'], weight: 0.2},
    // {words: ['white'], pictures: [], color: 'white', categories: ['colors'], weight: 0.2},
    {words: ['black'], pictures: [], color: 'black', categories: ['colors'], weight: 0.2},
    {words: ['purple'], pictures: [], color: 'purple', categories: ['colors'], weight: 0.2},
    {words: ['brown'], pictures: [], color: 'brown', categories: ['colors'], weight: 0.2},
    {words: ['pink'], pictures: [], color: 'pink', categories: ['colors'], weight: 0.2},
    {words: ['gray'], pictures: [], color: 'gray', categories: ['colors'], weight: 0.2},
